...
{
   // from nemea-test-1-startup-config-2.xml
...
{
   system("helpers/import_conf.sh -s nemea-test-1-startup-config-2.xml");
   connect_to_sr();
...
void test_module_load(void **state)
{
   ...
   { // test with allocated module struct passed
