...
if action == "intable_module_stats":
    xpath_base = "/nemea-tests-1:nemea-supervisor/module-group[name='Grp1']/module[name='Intable']/instance[name='Intable1']/stats/"
    try:
    ...
    xpath_base = "/nemea-tests-1:nemea-supervisor/module-group[name='Grp1']/module[name='Intable']/instance[name='Intable1']/interface/stats/"
    xpath_if1 = "/nemea-tests-1:nemea-supervisor/module-group[name='Grp1']/module[name='Intable']/instance[name='Intable1']/interface[name='if1']/stats/"
    xpath_if2 = "/nemea-tests-1:nemea-supervisor/module-group[name='Grp1']/module[name='Intable']/instance[name='Intable1']/interface[name='if2']/stats/"
    try:
    # tohle musi bejt!
        s = sess.get_items(xpath_base + '*')
        if s.val_cnt() != 6:
